...
public class BigFraction {
  ...
  /**
   * BigFraction constructor for a double value
   * @param val
   */
  ...
  /**
   * Simplifies a fraction down to into its simplest form
   */
  ...
  /**
   * returns the fractional of a fraction
   * @return - BigFraction
   */
